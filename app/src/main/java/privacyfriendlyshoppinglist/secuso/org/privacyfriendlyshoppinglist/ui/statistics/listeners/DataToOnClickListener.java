 ...
 */
public class DataToOnClickListener extends DateOnClickListener
{
    public DataToOnClickListener(StatisticsCache cache, StatisticsQuery query, TextView referenceTextView)
    {
